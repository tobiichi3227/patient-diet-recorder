...
class TestAPIEndpoints(unittest.TestCase):
    ...
    def test_full_flow_with_token(self, _, __):
        ...
        self.assertEqual(db.authenticate("monitor_renamed", "newpass"), AUTH_SUCCESS)
        ...
        self.assertEqual(res.json()["message"], FETCH_MONITORING_PATIENTS_SUCCESS)
        ...
        self.assertEqual(res.json()["message"], FETCH_UNMONITORED_PATIENTS_SUCCESS)
